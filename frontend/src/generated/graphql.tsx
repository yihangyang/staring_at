...
export type Mutation = {
  ...
  loginWithUsername: UserResponse;
  loginWithEmail: UserResponse;
...
export const ChangePasswordDocument = gql`
    mutation ChangePassword($token: String!, $newPasword: String!) {
  changePassword(token: $token, newPassword: $newPasword) {
    ...RegularUserResponse
  }
}
...
export const LoginWithEmailDocument = gql`
    mutation LoginWithEmail($options: EmailPasswordInput!) {
  loginWithEmail(options: $options) {
    ...RegularUserResponse
  }
}
    ${RegularUserResponseFragmentDoc}`;
...
export const LoginWithUsernameDocument = gql`
    mutation LoginWithUsername($options: UsernamePasswordInput!) {
  loginWithUsername(options: $options) {
    ...RegularUserResponse
  }
}
    ${RegularUserResponseFragmentDoc}`;
...
export function useLoginWithUsernameMutation() {
  return Urql.useMutation<LoginWithUsernameMutation, LoginWithUsernameMutationVariables>(LoginWithUsernameDocument);
};
